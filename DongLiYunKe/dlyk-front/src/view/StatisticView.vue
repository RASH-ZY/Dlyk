<template>
  ...
  <!-- 市场活动每月统计柱状图，为 ECharts 准备一个定义了宽高的 DOM -->
<!--  <div id="activityMonthChart" style="width: 48%; height:350px; margin:10px; float: left;"> 图渲染在此处 </div>-->
...
export default defineComponent({
  ...
  mounted() {
    ...
    // this.loadActivityMonthBarChart();
  },
  ...
  methods : {
    ...
    //加载市场活动每月统计柱状图
    // loadActivityMonthBarChart() {
    //   // let activityMonthData = resp.data.data;
    //   //1、拿到页面上渲染图表的dom元素
    //   var chartDom = document.getElementById('activityMonthChart');
    //   //2、使用echarts组件对dom进行初始化，得到一个空白的图表对象
    //   var myChart = echarts.init(chartDom);
    //   //3、配置可选项（查看文档-->配置项手册）
    //   var option = {
